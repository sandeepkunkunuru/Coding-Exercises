...
import me.tingri.courses.algorithms.uf.QuickFindUF;
...
public class QuickFindUFTest {
    ...
    public void testQuickFindUF_Ancestors() throws Exception {
        ...
        uf.union(0, 2); //Seetharamaiah is son of China Sobhanam
        uf.union(3, 4); //Alivelu is mother of Madhu
        uf.union(3, 5); //Alivelu is mother of Jyothsna
        uf.union(0, 6); //Seetharamaiah is father of Sudheer
        uf.union(7, 8); //Koteswara Rao is son of G.Seetharamaiah
        uf.union(3, 9); //Alivelu is mother of Raju
        uf.union(0, 10); //Seethramaiah is father of Saritha
        uf.union(5, 11); //Jyothsna is mother of Hymi
