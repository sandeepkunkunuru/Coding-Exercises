...
import kunkunur.org.projects.marsrovers.common.util.Logger;
...
public class MovementException extends Exception {
     ...
     */
    public MovementException(String message, String...params) {
     ...
     * @since  1.4
     */
    public MovementException(String message, Throwable cause, String...params) {
